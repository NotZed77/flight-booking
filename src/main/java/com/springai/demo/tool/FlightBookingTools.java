...
import com.springai.demo.dto.BookingListResponse;
import com.springai.demo.dto.BookingResponse;
import com.springai.demo.entity.BookingStatus;
import com.springai.demo.entity.FlightBooking;
import com.springai.demo.service.FlightBookingService;
...
public class FlightBookingTools {
    ...
    public BookingResponse createBooking(
        ...
        var flightBooking = flightBookingService.createBooking(userId, destination, departure);
    ...
    @Tool(
            ...
            description = "Retrieve all flight bookings for the current user, sorted by departure time (most recent first). " +
                    "Returns an empty list message if name exist."
    )
    ...
    @Tool(
            ...
            description = "Update the status of an existing flight booking (e.g., cancel it). " +
                    ...
                    "Common use: set status to be CANCELLED."
    )
